...
document.addEventListener('DOMContentLoaded', async function () {
  currentProgrammerId = await getProgrammerId();
  updateDateTime();
...
async function fetchReportData() {
  ...
  try {
    const response = await fetch('https://8001-01jrr2n0pracv1ekcjdzfy007x.cloudspaces.litng.ai/generate-report', {
      method: 'POST',
      mode: 'cors',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
        programmer_id: currentProgrammerId,
